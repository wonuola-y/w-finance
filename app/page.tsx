...
const PieChart = dynamic(() => import("./components/LandingBudgetChart"),{ssr:false});
const BudgetChart = dynamic(() => import('./modal/budgetChart'), {ssr:false} )
            ...
            <div className="px-2">
                ...
                <div className="my-12 px-3 rounded-lg lg:flex justify-between lg:w-[80%] lg:pr-4 lg:px-0 lg:border-brand-outline_gray lg:border-[1px]  " >
                    ...
                    <div className="lg:px-4  lg:py-4">
                        ...
                        <div className="lg:block hidden"><PieChart /></div>
                    </div>
                </div>
                </div>
